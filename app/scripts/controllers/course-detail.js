...
angular.module('statsdsuApp')
  .controller('CourseDetailCtrl', function ($scope, $routeParams,$location,$firebaseAuth,
                                            Course, Chapter, progressReport, $mdMedia, $firebaseArray
  ) {
