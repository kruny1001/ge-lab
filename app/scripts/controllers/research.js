...
/**
 * @ngdoc function
 * @name statsdsuApp.controller:ResearchCtrl
 * @description
 * # ResearchCtrl
 * Controller of the statsdsuApp
 */
angular.module('statsdsuApp')
  .controller('ResearchCtrl', function ($scope, $routeParams, $window,
                                        $compile,$mdDialog,
                                        $firebaseObject,$firebaseAuth,$firebaseArray,
                                        Course, Chapter, SECArray){
    $scope.userAuth = $firebaseAuth().$getAuth();
    $scope.targetMat = null;
    $scope.progressValue = 0;
    var materialId = '-KR9qmNMwbZHLTiHgby6';
