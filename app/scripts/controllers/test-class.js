...
/**
 * @ngdoc function
 * @name statsdsuApp.controller:TestClassCtrl
 * @description
 * # TestClassCtrl
 * Controller of the statsdsuApp
 */
angular.module('statsdsuApp')
  .controller('TestClassCtrl', function ($scope, $timeout) {

    $scope.source = "<iframe height='325' scrolling='no' src='//codepen.io/russellk/embed/preview/VjPQZR/?height=325&theme-id=light&default-tab=result&embed-version=2' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>See the Pen <a href='http://codepen.io/russellk/pen/VjPQZR/'>House of playing cards</a> by Russell Kitchen (<a href='http://codepen.io/russellk'>@russellk</a>) on <a href='http://codepen.io'>CodePen</a>.</iframe>"
    $scope.problem = {
      pre:"#no pec",
      sample:"#cretate a variable a, equal to 5",
      solution:"a<-5",
